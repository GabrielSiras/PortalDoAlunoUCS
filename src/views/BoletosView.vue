    ...
    <div class="card financeiro-card">
      ...
      <div class="mensalidades-grid">
        <div class="col-aberto">
          ...
          <div class="boleto-item" v-for="boleto in boletosAbertos" :key="boleto.id">
          ...
          <div v-if="boletosAbertos.length === 0" class="sem-boletos">Nenhum boleto em aberto</div>
        </div>
        ...
        <div class="col-pagas">
          ...
          <div class="paga-item" v-for="paga in mensalidadesPagas" :key="paga.id">
...
const boletosAbertos = reactive([
  { id: 1, data: '04/05/26', valor: '1000' },
])

const mensalidadesPagas = reactive([
...
function pagar(boleto) {
  const idx = boletosAbertos.indexOf(boleto)
  if (idx > -1) {
    boletosAbertos.splice(idx, 1)
    mensalidadesPagas.unshift({ id: Date.now(), data: boleto.data, valor: boleto.valor })
  }
}
</script>
